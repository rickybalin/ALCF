...
# Fortran inference routine
print("Launching Fortran inference routine ...")
Ftn_exe = 'src/inferenceFtn'
...
load_data = exp.create_model("inference", aprun)
exp.start(load_data, summary=False, block=True)
print("Done\n")
